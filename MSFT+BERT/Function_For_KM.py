...
def kmeans_clustering_with_elbow(tensor_list, save_path="/home/sql/zlj/ICLR_MSFT_New/MSFT+BERT/elbow_curve.png"):
    """
    ...
    # 新增保存代码
    torch.save(CC.cpu(), '/home/sql/zlj/ICLR_MSFT_New/MSFT+BERT/CC.pt')  # 保存到CPU张量格式
...
def Update_Raw_Datasets(original_data, record_data, index_column='index', ifchange_column='IfChange'):
    ...
    save_dataframe_to_json(original_df,r'/home/sql/zlj/ICLR_MSFT_New/MSFT+BERT/Running.json')
